...
public class SportsCategoryActivity extends AppCompatActivity {
    ...
    private SportsItemAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new SportsItemAdapter(itemsList);
        listView.setAdapter(adapter);

        fetchItemsByCategory("sport"); // keep your category name
    }
    ...
    private class SportsItemAdapter extends BaseAdapter {
        ...
        public SportsItemAdapter(List<Item> items) {
            this.items = items;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (view == null) {
                view = LayoutInflater.from(SportsCategoryActivity.this)
            ...
            Glide.with(SportsCategoryActivity.this)
